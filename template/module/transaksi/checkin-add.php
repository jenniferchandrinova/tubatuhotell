...
<section class="content">
	<div class="box">
		...
		<div class="alert alert-success">
			...
			<a href="?module=transaksi/checkin"><b>Back</b></a>
		</div>
		<?php } else { ?>
		...
		<form action="" method="post">
			<div class="box-body">
				<div class="row">
					...
					<div class="col-sm-3">
						...
						<div class="well">
							<a href="?module=tamu/tamu-add"><b>Click Here</b></a> if the specified guest name is not found to be added to the guest book list.
						</div>
					</div>
					<div class="col-sm-5">
						<div class="form-group">
			...
			<div class="box-footer">
				...
				<a class="btn btn-warning" href="?module=transaksi/checkin">Cancel</a>
			</div>
		</form>
		<?php } ?>
	</div>
