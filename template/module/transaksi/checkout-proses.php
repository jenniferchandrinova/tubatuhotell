...
<section class="content-header">
	<h1>Check Out <span class="small">Guets check-out process</span></h1>
</section>
...
<section class="content">
	<div class="box">
		...
		<div class="alert alert-success">
			<h4>Data Recorded!</h4>
			Successfully checked out room number: <?php echo $transaksi_kamar['nomor_kamar']; ?>. 
		...
		<form action="" method="post">
			...
			<div class="box-footer">
				...
				<a class="btn btn-primary" href="?report=transaksi-tamu&transaksi=<?php echo $transaksi_kamar['id_transaksi_kamar']; ?>" target="_blank">Print Invoice</a>
				<a class="btn btn-danger" href="?module=transaksi/checkin">Cancel</a>
			</div>
		</form>
		<?php } ?>
	</div>
