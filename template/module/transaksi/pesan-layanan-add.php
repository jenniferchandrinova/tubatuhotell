...
<section class="content-header">
	<h1>Room Services <span class="small">Choose products / services</span></h1>
</section>

<section class="content">
	<div class="box">
		<div class="box-header">
			<h3 class="box-title">ROOM ORDER: 
				<b><?php echo $kamar_view['nomor_kamar']; ?></b> - 
				<b><?php echo $tamu_view['prefix'].'. '.$tamu_view['nama_depan'].'&nbsp;'.$tamu_view['nama_belakang']; ?></b>
			</h3>
			<a class="btn btn-danger pull-right" href="?module=transaksi/pesan-layanan">Cancel Order</a>
		</div>
		<div class="box-body">
			...
			<div class="alert alert-success">
				<h4>Success!</h4>
				You have successfully added an order to the room <?php echo $kamar_view['nomor_kamar']; ?>. 
